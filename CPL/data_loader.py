...
class BERTDataset(Dataset):    
    ...
    #     # Convert the list of numpy arrays into a single numpy array and then convert to tensor
    #     batch_instance['ids'] = torch.tensor(np.array([item[0]['ids'] for item in data]))
