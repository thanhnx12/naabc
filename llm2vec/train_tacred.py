...
class Manager(object):
    ...
    def train_model(self, encoder_llm, training_data, seen_des, seen_relations, list_seen_des, is_memory=False):
        ...
        for i in range(epoch):
            ...
            for batch_num, (instance, labels, ind) in enumerate(data_loader):
                ...
                batch_instance = [seen_des[self.id2rel[label.item()]]['input'] for label in labels]
                
                hidden = encoder_llm(instance) # b, dim
                rep_des = encoder_llm(batch_instance) # b, dim
    ...
    def train(self):
        ...
        encoder_llm = EncodingModel(self.config)
